      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:ZephyrChenWork@outlook.com'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://github.com/Zephyrccc'
        }
      ]
    },
    footer:{ // 页脚信息
      createYear: 2021, // 博客创建年份
      copyrightInfo: 'Zephyr | <a href="https://github.com/xugaoyi/vuepress-theme-vdoing/blob/master/LICENSE" target="_blank">MIT License</a>', // 博客版权信息，支持a标签
    },
    htmlModules
  },
  plugins: [ 
    ...
    [
      ...
      // },
      {
        choosen: 'gitalk', 
        options: {
          clientID: 'eccabcaebfef8b502e3d',
          clientSecret: 'd71827683c355fcaa985a6faac3b68a079dc971d',
          repo: 'Blog', // GitHub 仓库
          owner: 'Zephyrccc', // GitHub仓库所有者
          admin: ['Zephyrccc'], // 对仓库有写权限的人
